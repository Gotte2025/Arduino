...
void setup() {
  ...
  Serial.begin(9600);
  servo1.attach (9);       // Define el pin 9 para el servo09
  servo2.attach (10);       // Define el pin 9 para el servo09
  servo3.attach (11);       // Define el pin 9 para el servo09
  servo4.attach (12);       // Define el pin 9 para el servo09
  servo5.attach (6);       // Define el pin 9 para el servo09
  servo6.attach (8);       // Define el pin 9 para el servo09
...
void servocrece1()
{
  for (angulo = 0; angulo <= 60; angulo += 1)
  {
    servo1.write(angulo);
    delay(50);
  }
...
void servodecrece1()
{
  for (angulo = 60; angulo >= 0; angulo -= 1)
  {
    servo1.write(angulo);
    delay(50);
  }
