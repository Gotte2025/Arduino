...
void setup() {
  ...
  servo1.attach (9);       // Define el pin 9 
  servo2.attach (10);       // Define el pin 10 
  servo3.attach (11);       // Define el pin 11 
  servo4.attach (12);       // Define el pin 12 
  servo5.attach (6);       // Define el pin 6 
  servo6.attach (8);       // Define el pin 8 
  servo7.attach (5);       // Define el pin 5
