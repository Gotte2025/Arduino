...
void avanzar()
{
  ...
  analogWrite(enA, 80);   // Velocidad máxima (0-255)
}
void avanzarB()
{
  ...
  analogWrite(enB, 80);   // Velocidad máxima (0-255)
}
void avanzar2()
{
...
void retroceder1()
{
  ...
  digitalWrite(in1, LOW);  // Dirección 1 LOW
  digitalWrite(in2, HIGH); // Dirección 2 HIGH
  analogWrite(enA, 90);   // Velocidad máxima (0-255)
}
void retroceder1B()
{
  ...
  digitalWrite(in3, LOW);  // Dirección 1 LOW
  digitalWrite(in4, HIGH); // Dirección 2 HIGH
  analogWrite(enB, 90);   // Velocidad máxima (0-255)
}
