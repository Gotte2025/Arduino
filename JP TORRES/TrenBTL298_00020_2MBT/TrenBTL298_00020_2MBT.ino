...
void retroceder()
{
  ...
  analogWrite(enA, 120);   // Velocidad máxima (0-255)
}
void retrocederB()
{
  ...
  analogWrite(enB, 120);   // Velocidad máxima (0-255)
}
void retroceder1()
{
  ...
  digitalWrite(in1, LOW);  // Dirección 1 LOW
  digitalWrite(in2, HIGH); // Dirección 2 HIGH
  analogWrite(enA, 200);   // Velocidad máxima (0-255)
}
void retroceder1B()
{
  ...
  digitalWrite(in3, LOW);  // Dirección 1 LOW
  digitalWrite(in4, HIGH); // Dirección 2 HIGH
  analogWrite(enB, 200);   // Velocidad máxima (0-255)
}
