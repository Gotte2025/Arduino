...
void avanzar()
{
  ...
  analogWrite(enA, 55);   // Velocidad máxima (0-255)
}
void avanzarB()
{
  ...
  analogWrite(enB, 55);   // Velocidad máxima (0-255)
}
void avanzar2()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 65);   // Velocidad máxima (0-255)
}
void avanzar2B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 65);   // Velocidad máxima (0-255)
}
void avanzar3()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 85);   // Velocidad máxima (0-255)
}
void avanzar3B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 85);   // Velocidad máxima (0-255)
}
void avanzar4()
{
...
void avanzar4B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 100);   // Velocidad máxima (0-255)
}
void retroceder()
{
  ...
  analogWrite(enA, 50);   // Velocidad máxima (0-255)
}
void retrocederB()
{
  ...
  analogWrite(enB, 50);   // Velocidad máxima (0-255)
}
void retroceder1()
{
...
void retroceder1B()
{
  ...
  digitalWrite(in3, LOW);  // Dirección 1 LOW
  digitalWrite(in4, HIGH); // Dirección 2 HIGH
  analogWrite(enB, 60);   // Velocidad máxima (0-255)
}
