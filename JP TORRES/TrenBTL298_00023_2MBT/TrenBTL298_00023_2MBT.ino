...
void avanzar2()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 125);   // Velocidad máxima (0-255)
}
void avanzar2B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 125);   // Velocidad máxima (0-255)
}
void avanzar3()
{
...
void avanzar4()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 240);   // Velocidad máxima (0-255)
}
void avanzar4B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 240);   // Velocidad máxima (0-255)
}
void retroceder()
{
...
void retroceder1()
{
  ...
  digitalWrite(in1, LOW);  // Dirección 1 LOW
  digitalWrite(in2, HIGH); // Dirección 2 HIGH
  analogWrite(enA, 70);   // Velocidad máxima (0-255)
}
void retroceder1B()
{
  ...
  digitalWrite(in3, LOW);  // Dirección 1 LOW
  digitalWrite(in4, HIGH); // Dirección 2 HIGH
  analogWrite(enB, 70);   // Velocidad máxima (0-255)
}
