...
void avanzarC()
{
  ...
  analogWrite(enC, 150);   // Velocidad máxima (0-255)
}
void avanzar2()
{
...
void avanzar2B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 180);   // Velocidad máxima (0-255)
}
void avanzar2C()
{
  ...
  digitalWrite(in5, HIGH); // Dirección 1 HIGH
  digitalWrite(in6, LOW);  // Dirección 2 LOW
  analogWrite(enC, 180);   // Velocidad máxima (0-255)
}
void avanzar3()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 210);   // Velocidad máxima (0-255)
}
void avanzar3B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 210);   // Velocidad máxima (0-255)
}
void avanzar3C()
{
  ...
  digitalWrite(in5, HIGH); // Dirección 1 HIGH
  digitalWrite(in6, LOW);  // Dirección 2 LOW
  analogWrite(enC, 210);   // Velocidad máxima (0-255)
}
void avanzar4()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 230);   // Velocidad máxima (0-255)
}
void avanzar4B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 230);   // Velocidad máxima (0-255)
}
void avanzar4C()
{
  ...
  digitalWrite(in5, HIGH); // Dirección 1 HIGH
  digitalWrite(in6, LOW);  // Dirección 2 LOW
  analogWrite(enC, 230);   // Velocidad máxima (0-255)
}
void avanzar5()
{
  ...
  digitalWrite(in1, HIGH); // Dirección 1 HIGH
  digitalWrite(in2, LOW);  // Dirección 2 LOW
  analogWrite(enA, 254);   // Velocidad máxima (0-255)
}
void avanzar5B()
{
  ...
  digitalWrite(in3, HIGH); // Dirección 1 HIGH
  digitalWrite(in4, LOW);  // Dirección 2 LOW
  analogWrite(enB, 254);   // Velocidad máxima (0-255)
}
void avanzar5C()
{
  ...
  digitalWrite(in5, HIGH); // Dirección 1 HIGH
  digitalWrite(in6, LOW);  // Dirección 2 LOW
  analogWrite(enC, 254);   // Velocidad máxima (0-255)
}
void retroceder()
{
...
void retroceder1C()
{
  ...
  digitalWrite(in5, LOW);  // Dirección 1 LOW
  digitalWrite(in6, HIGH); // Dirección 2 HIGH
  analogWrite(enC, 190);   // Velocidad máxima (0-255)
}
