...
void handleRoot() {
  ...
  rootWebPage += "<center> ";
  rootWebPage += "<h1>                       MINI ESTACION METEOROLOGICA</h1>";
  rootWebPage += "</center> ";
  rootWebPage += "<img src=\"/CLIMA.jpg\" alt=\"\"  height=300 width=400 /><br/>";
  rootWebPage += "<p>  </p>"; 
  rootWebPage += "<p>  </p>"; 
  ...
  rootWebPage += "<p>  </p>"; 
  rootWebPage += "<p>  </p>";
  rootWebPage += "<p>=Luz encendida: " + String(ilum) + " </p>";      // Asi se suben los valores a la Access point
  rootWebPage += "<p>  </p>";
