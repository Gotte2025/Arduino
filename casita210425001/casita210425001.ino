...
void handleRoot() {
  ...
  String rootWebPage = "<!DOCTYPE html><html><head><title>:: CASITA DEL CLIMA :: </title>";
  rootWebPage += "<body bgcolor=WHITE> ";
  rootWebPage += "<center> ";
  rootWebPage += "<h1>CASITA DEL CLIMA</h1>";
  rootWebPage += "</center> ";
  ...
  rootWebPage += "<center> ";
  rootWebPage += "<H3>La Casita del clima, nos informa de la condiciones del tiempo, si el viejo está fuera, el clima es bueno y si la vieja lo está es posible que llueva.</H3>";
  rootWebPage += "<center> ";
